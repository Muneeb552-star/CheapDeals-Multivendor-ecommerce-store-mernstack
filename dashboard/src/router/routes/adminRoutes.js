...
export const adminRoutes = [
    ...
    { path: 'admin/dashboard/sellers-request', element: <SellersRequest />, role : 'admin'},
    { path: 'admin/dashboard/seller/details/:sellerId', element: <SellerDetail />, role : 'admin'},
    { path: 'admin/dashboard/chat-seller', element: <ChatSeller />, role : 'admin'},
