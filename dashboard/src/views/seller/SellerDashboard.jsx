    ...
    <Box>
        ...
        <Grid container spacing={3}>
            ...
            <Paper elevation={2}>
              <Box p={2} sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                <TextContainer>
                    ...
                    <Typography variant="span"> Pending Orders </Typography>
                </TextContainer>
              ...
              <Paper elevation={2}>
                <Box p={2}>
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', paddingY: '1rem' }}>
                    <Typography variant='span'> Recent Customer Message </Typography>
                  ...
                  {/* List Items Section Starts Here */}
                    <Box sx={{ display: 'flex', marginY: '1rem'}}>
                      ...
                      <Box sx={{ width: '100%' }}>
                        <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                          <Typography variant='subtitle2' pl={2} pr={2}>Customer Name</Typography>
                    ...
                    <Box sx={{ display: 'flex', marginY: '1rem' }}>
                      ...
                      <Box sx={{ width: '100%' }} >
                        <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                          <Typography variant='subtitle2' pl={2} pr={2}>Seller</Typography>
                          <Typography variant='subtitle2'>10:42 PM</Typography>
                        </Box>
                        <Typography pl={2}> Lorem ipsum, dolor sit amet consectetur adipisicing elit. </Typography>
                      </Box>
          ...
          <Grid item xs={12}>
              ...
              <Typography variant='h6' pl={2} pt={2}>Recent Orders</Typography>
