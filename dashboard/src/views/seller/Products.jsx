...
import { Box, Paper, Typography, Grid, styled, TextField } from "@mui/material"
...
import DeleteForeverIcon from '@mui/icons-material/DeleteForever';
  ...
  */ 
    const rows = filteredRows.length > 0 
        ...
        : products.map((row, index) => ({ ...row, id: row._id, no: `${index + 1}` }))

  
    const NoRowsOverlay = () => {
        return (
            <div style={{ width: '100%', height: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', color: 'gray' }}>
                {loader 
