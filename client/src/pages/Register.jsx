    ...
    <div>
      ...
      <div className="bg-slate-200 mt-4">
        <div className="w-full justify-center items-center p-10">
          <div className="grid grid-cols-2 md:grid-cols-1 w-[70%] md:w-[100%] mx-auto bg-white rounded-md">
            <div className="p-8">
              ...
              <div className="text-center text-slate-600 pt-1">
                <p>Have an account ? <Link to="/login" className="text-[#ed6c02]">Login</Link></p>
              </div>
            </div>
